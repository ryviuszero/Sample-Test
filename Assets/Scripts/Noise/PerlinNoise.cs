...
{
    public string saveToDiskPath = "Assets/Textures";
    ...
    [Range(0, 8)] public int fbmInteration = 0;
    ...
    {
        if (remapTo01 || invert || changeContrast)
        {
            return true;
        }
        return false;
    ...
    public virtual void Generate()
    {
        ...
        cs_core.SetInt("_FBMIteration", fbmInteration);
